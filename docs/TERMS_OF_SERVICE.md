...
By creating an account, accessing, or using the Service, you acknowledge that you have read, understood, and agree to be bound by these Terms, as well as our [Privacy Policy](/docs/PRIVACY_POLICY.md), which is incorporated herein by reference.
...
- Sending you an email notification at least 30 days before material changes take effect
...
- **Communication:** Facilitate messaging between tutors and parents
- **Payment Processing:** Generate invoices and process payments for tutoring services
- **Resource Sharing:** Share educational materials and assignments with students and parents
- **Reporting:** Track lesson history, attendance, and payment records
...
**Tutor Accounts:** For tutoring professionals who wish to manage their tutoring business, including student records, scheduling, and payments.

**Parent Accounts:** For parents or guardians of students, providing access to lesson schedules, communication with tutors, payment history, and shared educational resources.
...
- Not create multiple accounts for the purpose of circumventing our policies

### 3.5 Account Sharing

Accounts are for individual use only. You may not share your account credentials with others or allow others to access your account.
...
The Service is offered on a subscription basis. Current subscription plans and pricing are available on our website and within the application.
...
- Billing occurs on the same day each month/year as your initial subscription date

### 4.3 Payment Processing

- Payments are processed through Stripe, our third-party payment processor
- By providing payment information, you authorize us to charge your payment method for all fees incurred
...
- Apply to the next billing cycle after the effective date
- Not affect the current billing cycle

### 4.5 Free Trial

We may offer a free trial period for new subscribers. At the end of the free trial:
- You will be automatically charged the applicable subscription fee unless you cancel
- Free trial availability and duration may vary
...
- No refunds will be provided for accounts terminated due to violation of these Terms

### 4.7 Failed Payments

If a payment fails:
- We will attempt to process the payment again within 3 business days
- We will notify you of the failed payment
- Your access to the Service may be suspended until payment is successfully processed
- Accounts with payments more than 30 days overdue may be terminated
...
- No partial refunds will be provided for unused time in the current billing period
...
### 5.2 Tutor Responsibilities

Tutors using the Service are additionally responsible for:
- Obtaining appropriate consent from parents before entering student information
- Complying with applicable laws regarding student data privacy (including FERPA and COPPA)
- Ensuring the accuracy of student information entered into the system
- Maintaining appropriate professional standards in interactions with parents and students
- Setting fair and transparent pricing for tutoring services
- Delivering tutoring services as scheduled

### 5.3 Parent Responsibilities

Parents using the Service are responsible for:
- Providing accurate information about their children
- Reviewing and approving lesson schedules
- Making timely payments for tutoring services
- Communicating schedule changes in a timely manner
- Ensuring their children's participation in scheduled lessons

### 5.4 Content Responsibility

You are solely responsible for all content you upload, post, or transmit through the Service, including:
...
**Harmful Conduct:**
- Harassing, threatening, intimidating, or abusing others
- Posting or transmitting content that is defamatory, obscene, or offensive
- Engaging in discrimination based on race, gender, religion, nationality, disability, sexual orientation, or age
...
- Reverse engineering or attempting to extract the source code of the Service

**Commercial Violations:**
- Using the Service to promote competing products or services
- Reselling or redistributing access to the Service
- Using the Service for purposes other than managing tutoring services
...
- Not contain personally identifiable information of third parties without their consent
- Not infringe upon intellectual property rights
...
You retain ownership of any content you create and upload to the Service. By uploading content, you grant us a limited, non-exclusive, royalty-free license to:
- Store and display your content as necessary to provide the Service
- Create backups of your content
- Share your content with users you authorize (e.g., parents accessing shared resources)

This license terminates when you delete your content or close your account, except for content that has been shared with others or is necessary for legal compliance.

### 7.3 Feedback

If you provide feedback, suggestions, or ideas about the Service ("Feedback"), you grant us a perpetual, irrevocable, royalty-free license to use, modify, and incorporate that Feedback into the Service without any obligation to you.
...
- **Implied Warranties:** Warranties of merchantability, fitness for a particular purpose, and non-infringement
- **Accuracy:** We do not warrant that the Service will be error-free, accurate, or reliable
- **Availability:** We do not warrant that the Service will be uninterrupted, secure, or free from viruses or other harmful components
- **Results:** We do not warrant that the Service will meet your specific requirements or achieve any particular results

### 8.3 Third-Party Services

We do not warrant or endorse any third-party services, content, or products referenced or linked through the Service. Use of third-party services is at your own risk.

### 8.4 Tutoring Services

We do not provide tutoring services and are not responsible for:
- The quality of tutoring services provided by tutors using the Service
- Disputes between tutors and parents
- The qualifications, credentials, or conduct of tutors
...
TO THE FULLEST EXTENT PERMITTED BY LAW, IN NO EVENT SHALL LOVE2LEARN, ITS DIRECTORS, OFFICERS, EMPLOYEES, AGENTS, OR AFFILIATES BE LIABLE FOR:

- Indirect, incidental, special, consequential, or punitive damages
- Loss of profits, revenue, data, or business opportunities
- Damages arising from your use of or inability to use the Service
- Damages arising from any conduct or content of any third party using the Service
- Damages arising from unauthorized access to or alteration of your data

### 9.2 Limitation of Liability

TO THE FULLEST EXTENT PERMITTED BY LAW, OUR TOTAL LIABILITY TO YOU FOR ANY CLAIMS ARISING FROM OR RELATED TO THESE TERMS OR THE SERVICE SHALL NOT EXCEED THE GREATER OF:
...
THE LIMITATIONS AND EXCLUSIONS IN THIS SECTION REFLECT THE ALLOCATION OF RISK BETWEEN YOU AND US AND ARE AN ESSENTIAL BASIS OF THE BARGAIN BETWEEN US. WE WOULD NOT PROVIDE THE SERVICE WITHOUT THESE LIMITATIONS.
...
- Your tutoring services (if you are a tutor)
...
- Provisions of these Terms that by their nature should survive termination will survive (including Sections 7, 8, 9, 10, 13, and 14)

### 11.4 No Refund Upon Termination for Cause
...
- Arbitration will take place in Delaware or, at your election, by telephone or video conference
- The arbitrator's decision will be final and binding
- Judgment on the arbitration award may be entered in any court of competent jurisdiction

### 12.3 Class Action Waiver

YOU AND LOVE2LEARN AGREE THAT EACH MAY BRING CLAIMS AGAINST THE OTHER ONLY IN YOUR OR ITS INDIVIDUAL CAPACITY, AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS OR REPRESENTATIVE PROCEEDING.
...
Subject to the arbitration provisions above, any legal action or proceeding arising from or relating to these Terms shall be brought exclusively in the state or federal courts located in Delaware. You consent to the personal jurisdiction and venue of such courts.
...
We shall not be liable for any failure or delay in performance due to causes beyond our reasonable control, including acts of God, natural disasters, pandemics, war, terrorism, riots, embargoes, acts of civil or military authorities, fire, floods, accidents, strikes, or shortages of transportation, facilities, fuel, energy, labor, or materials.
