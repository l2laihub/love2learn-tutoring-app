...
// Mirrors src/lib/prepaidCoverage.test.ts so the edge job's copy stays in lockstep
// with the app's calendar-completion rule.

Deno.test('no prepaid payment row at all -> uncovered', () => {
